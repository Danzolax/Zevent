...
import com.zolax.zevent.ui.viewmodels.EventPlayersViewModel
import com.zolax.zevent.util.Resource
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.android.synthetic.main.fragment_event_players.*

@AndroidEntryPoint
class EventPlayersFragment : Fragment(R.layout.fragment_event_players) {
    private val eventPlayersViewModel : EventPlayersViewModel by viewModels()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        subscribeObservers()
        eventPlayersViewModel.getPlayersByEventId(event.id!!)
    }

    private fun subscribeObservers() {
        eventPlayersViewModel.players.observe(viewLifecycleOwner,{result ->
            when(result){
                is Resource.Success ->{
    ...
    private fun initAdapter(recyclerView: RecyclerView) {
        ...
        eventPlayersAdapter = EventPlayersAdapter(event.category == "Другое",false)
        recyclerView.apply {
