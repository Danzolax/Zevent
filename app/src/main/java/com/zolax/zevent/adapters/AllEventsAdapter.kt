...
class AllEventsAdapter : RecyclerView.Adapter<AllEventsAdapter.AllEventsViewHolder>() {
...
//    private var onSubscribeButtonClickListener: ((Event) -> Unit)? = null
//
//    fun setOnMapButtonClickListener(listener: ((Event) -> Unit)) {
//        onMapButtonClickListener = listener
//    }
//    fun setOnSubscribeButtonClickListener(listener: ((Event) -> Unit)) {
//        onSubscribeButtonClickListener = listener
//    }
